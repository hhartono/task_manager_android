 ...
 */
public class LoadTaskActivity extends ListActivity{
    ...
    class LoadTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            pDialog = new ProgressDialog(LoadTaskActivity.this);
        ...
        protected String doInBackground(String... args){
            // set end point
            String endPointGetAllTugas = "tugas/get_all_tugas";
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            LoadTaskActivity.this, taskList,
